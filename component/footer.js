function footer() {
    ...
    <div class="brand1">
      ...
      <div class="social1">
        <a href="#twitter" class="social-icon1">
        ...
        <a href="#youtube" class="social-icon1">
